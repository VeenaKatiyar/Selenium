...
public class Xls_Reader {
	...
	public static void exportDataToExcel(String filePath){
		try{
			...
			cell1.setCellValue("Vaiable Name");
			...
			int count =1;
			Set<String> keys = driverScript.testData.keySet();
			for(String key: keys){
				...
				cell2.setCellValue(driverScript.testData.get(key));
